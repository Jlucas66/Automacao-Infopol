...
def main():
    ...
    print(f"Total encontrado: {len(usuarios)}")
    ...
    for i, usuario in enumerate(usuarios):
        ...
        try:
            ...
            print("[OK] Usuário criado no SIP")
            ...
            permissao.preencher(sigla)

            permissao.salvar()


            print(
                f"[OK] {usuario.nome} cadastrado com sucesso"
            )
            ...
            print(
                f"[ERRO] Falha ao processar {usuario.nome}: {erro}"
            )
